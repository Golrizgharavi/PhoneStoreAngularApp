        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else if(Request.Params["q"] != null && Request.Params["q"] == "3")
            {
...

                {
                    ...
                    string myJson ="";
                    myJson += "{\"OSs\":[{\"n\":\"" + OsType.Android.ToString() + "\", \"val\": \"" + Convert.ToInt32(OsType.Android) + "\"}, {\"n\":\"" + OsType.IOS.ToString() + "\", \"val\":\"" + Convert.ToInt32(OsType.IOS) + "\"}], \"Brds\":[{\"n\":\"" + Brands.Samsung.ToString() + "\" , \"val\":\"" + Convert.ToInt32(Brands.Samsung) + "\"},{\"n\":\"" + Brands.Apple.ToString() + "\" , \"val\":\"" + Convert.ToInt32(Brands.Apple) + "\"},{\"n\":\"" + Brands.Microsoft.ToString() + "\" , \"val\":\"" + Convert.ToInt32(Brands.Microsoft) + "\"}, {\"n\":\"" + Brands.Sony.ToString() + "\" , \"val\":\"" + Convert.ToInt32(Brands.Sony) + "\"}], ";
                    myJson += "\"DataArr\":[";
                    int i = 1;
